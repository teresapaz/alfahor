...
LIST=("
ftp://ftp.cv.nrao.edu/NRAO-staff/rloomis/MAPS/HD_163296/images/CO/robust_0.5/HD_163296_CO_220GHz.robust_0.5.JvMcorr.image.fits
")
...
echo "Downloading the following files in up to 5 parallel streams. Total size is 1.98 GB."
echo "${LIST}"
